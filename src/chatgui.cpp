...
ChatBotPanelDialog::ChatBotPanelDialog(wxWindow *parent, wxWindowID id)
  ...
  // packing the object into the smart pointer immediately after creation
  _chatLogic = std::make_unique<ChatLogic>();

  // smart pointer is dereferenced to the managed object -> no need to adjust these two:
...
ChatBotPanelDialog::~ChatBotPanelDialog() {
  ...
  // Now handled by the unique pointer -> no manual deletion necessary
  // delete _chatLogic;
